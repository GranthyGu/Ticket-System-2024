...
private:
    B_plus_tree<train_id, information, 130, 2> basic_information;
    B_plus_tree<train_id, train_information, 130, 2> advanced_information;
    B_plus_tree<station, std::pair<int, int>, 55, 40> released_station_train_id_list;
