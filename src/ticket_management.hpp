...
private:
    ...
    B_plus_tree<key_for_ticket, info_for_ticket, 120, 60> standby_by_train_date;
    B_plus_tree<key_for_ticket_user, info_for_ticket_user, 120, 60> ticket_list_by_user;
