...
public:
    ...
    char password[30];
    username_password() {}
    username_password(std::string str1, std::string str2) {
    ...
    username_password operator=(const username_password& other) {
        for (int i = 0; i < 20; i++) {
    ...
    bool operator<(const username_password& other) {
        for (int i = 0; i < 20; i++) {
...
public:
    ...
    char name[20];
    username_name() {}
    username_name(std::string str1, std::string str2) {
        for (int i = 0; i < str1.length(); i++) {
            username[i] = str1[i];
        }
        for (int i = 0; i < str2.length(); i++) {
    ...
    username_name operator=(const username_name& other) {
        for (int i = 0; i < 20; i++) {
            username[i] = other.username[i];
        }
        for (int i = 0; i < 20; i++) {
    ...
    bool operator<(const username_name& other) {
        for (int i = 0; i < 20; i++) {
            if (username[i] != other.username[i]) {
                return username[i] < other.username[i];
            }
...
public:
    ...
    username_mail_address(std::string str1, std::string str2) {
        for (int i = 0; i < str1.length(); i++) {
            username[i] = str1[i];
        }
        for (int i = 0; i < str2.length(); i++) {
    ...
    username_mail_address operator=(const username_mail_address& other) {
        for (int i = 0; i < 20; i++) {
            username[i] = other.username[i];
        }
        for (int i = 0; i < 30; i++) {
    ...
    bool operator<(const username_mail_address& other) {
        for (int i = 0; i < 20; i++) {
            if (username[i] != other.username[i]) {
                return username[i] < other.username[i];
            }
...
public:
    ...
    int privilege;
    username_privilege() {}
    username_privilege(std::string str1, std::string str2) {
        for (int i = 0; i < str1.length(); i++) {
            username[i] = str1[i];
        }
        privilege = std::stoi(str2);
    }
    username_privilege operator=(const username_privilege& other) {
        for (int i = 0; i < 20; i++) {
            username[i] = other.username[i];
        }
        privilege = other.privilege;
    }
    bool operator<(const username_privilege& other) {
        for (int i = 0; i < 20; i++) {
            if (username[i] != other.username[i]) {
                return username[i] < other.username[i];
            }
...
public:
    ...
    void add_user(const token_scanner& ts) {
    ...
    void log_in(const token_scanner& ts) {
    ...
    void log_out(const token_scanner& ts) {
    ...
    void query_profile(const token_scanner& ts) {
    ...
    void modify_profile(const token_scanner& ts) {
